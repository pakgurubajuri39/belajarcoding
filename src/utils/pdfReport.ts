...
export function generateStudentProgressPDF(progress: StudentProgress, session: UserSession) {
  ...
  doc.setFont('helvetica', 'bold');
  doc.setFontSize(15);
  doc.text('DJURAGAN CODING', 14, 14);
  ...
  doc.text('Verifikasi Digital: DJuragan-Progress-Valid', 145, 287);
  ...
  doc.setFont('helvetica', 'bold');
  doc.setFontSize(9.5);
  doc.text('DJURAGAN CODING - LAPORAN CAPAIAN SEMESTER GENAP & PRESTASI', 14, 10.5);
  doc.setFontSize(7.5);
  doc.setFont('helvetica', 'normal');
  doc.setTextColor(203, 213, 225);
  ...
  doc.text('Instruktur Utama DJuragan Coding', 142, y + 11);
  ...
  doc.setFont('helvetica', 'normal');
  doc.setTextColor(99, 102, 241);
  doc.text('Akademi DJuragan Coding', 164, y + 25, { align: 'center' });
