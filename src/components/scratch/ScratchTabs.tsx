...
export const ScratchTabs: React.FC<ScratchTabsProps> = ({
  ...
  return (
    <div className="bg-[#E9F1FC] border-b border-[#D0E2FB] px-2 pt-1 flex items-end justify-between select-none">
      ...
      <div className="flex items-end gap-1 text-xs">
        ...
        <button
          ...
          className={`flex items-center gap-1.5 px-3.5 py-1.5 rounded-t-lg font-bold transition-all border-t border-x ${
            activeTab === 'code'
      ...
      <div className="flex items-center gap-1 pb-1">
        ...
        <button
          onClick={onStopSign}
          className="p-1.5 rounded-md hover:bg-rose-100/80 active:scale-95 text-[#FF4D4D] transition-all flex items-center justify-center"
        ...
        <button
          ...
          className={`p-1 rounded text-xs transition-colors ${
            stageLayout === 'small' ? 'bg-white shadow-sm text-[#4C97FF]' : 'text-slate-500 hover:text-slate-800'
          }`}
        ...
        <button
          ...
          className={`p-1 rounded text-xs transition-colors ${
            stageLayout === 'standard' ? 'bg-white shadow-sm text-[#4C97FF]' : 'text-slate-500 hover:text-slate-800'
          }`}
        ...
        <button
          ...
          className={`p-1 rounded text-xs transition-colors ${
            isMaximized ? 'bg-white shadow-sm text-[#4C97FF]' : 'text-slate-500 hover:text-slate-800'
          }`}
