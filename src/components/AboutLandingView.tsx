...
export const AboutLandingView: React.FC<AboutLandingViewProps> = ({
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Kode akses resmi diberikan oleh guru pembina ekstrakurikuler, sekolah mitra, atau tim instruktur DJuragan Coding. Pengguna baru juga dapat langsung mencoba Mode Trial Gratis (Level 1) tanpa kode akses kapan saja.'
    },
    {
  ...
  return (
    <div className="space-y-12 pb-16">
      ...
      <section className="relative rounded-3xl bg-slate-900 border border-slate-700/80 p-6 sm:p-10 lg:p-14 text-white shadow-2xl overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-sm sm:text-base lg:text-lg text-slate-300 max-w-2xl mx-auto leading-relaxed">
            Selamat datang di <strong>DJuragan Coding</strong>. Panduan belajar koding visual Scratch 3.0 paling lengkap, terstruktur, dan bertahap. Melatih nalar logika, matematika, perancangan game, dan dasar kecerdasan buatan sejak usia dini.
          </p>
      ...
      {/* 2. WHY DJURAGAN CODING: EDUCATIONAL VALUE & COMPARISON */}
      <section className="space-y-6">
        <div className="text-center max-w-3xl mx-auto space-y-2">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 text-xs font-bold uppercase tracking-wider">
            ...
            <span>Mengapa Memilih DJuragan Coding?</span>
          </div>
        ...
        <div className="p-6 sm:p-8 rounded-3xl bg-gradient-to-br from-slate-900 via-indigo-950/40 to-slate-900 border border-slate-800 text-white shadow-xl">
          <div className="text-center max-w-xl mx-auto mb-6">
            ...
            <p className="text-xs text-slate-400 mt-1">Bandingkan aktivitas pasif dengan pengalaman belajar produktif di DJuragan Coding</p>
          </div>
      ...
      <section className="space-y-4 max-w-3xl mx-auto">
        <div className="text-center space-y-1.5 mb-6">
          ...
          <h2 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white">
            Tanya Jawab Seputar DJuragan Coding
          </h2>
        </div>
      ...
      <section className="p-8 sm:p-12 rounded-3xl bg-gradient-to-r from-indigo-900 via-slate-900 to-indigo-950 border border-indigo-500/30 text-white text-center space-y-6 shadow-2xl relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto space-y-4">
          ...
          <p className="text-xs sm:text-sm text-slate-300 leading-relaxed">
            Bergabunglah bersama ribuan siswa lainnya yang telah merasakan serunya belajar logika komputasional dan membuat game impian mereka di DJuragan Coding!
          </p>
