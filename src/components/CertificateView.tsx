    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-16">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400">
            Bukti resmi pencapaian belajar pemrograman Scratch & Kecerdasan Buatan di Sobat Coding.
          </p>
        </div>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center text-center space-y-6">
          ...
          <p className="max-w-2xl text-xs sm:text-sm text-slate-300 leading-relaxed">
            ...
            <strong> Ekstrakurikuler Coding Scratch & Kecerdasan Buatan</strong> pada platform <strong>Sobat Coding</strong>, 
          ...
          <div className="w-full max-w-2xl flex items-end justify-between pt-6 border-t border-white/10 text-xs">
            ...
            <div className="flex flex-col items-center space-y-1">
              ...
              <span className="text-[9px] text-slate-500">Sobat Coding Academy</span>
            </div>
      ...
      {!isAllCompleted && (
        <div className="p-4 rounded-2xl bg-amber-500/10 border border-amber-500/30 text-amber-800 dark:text-amber-300 text-xs flex items-center gap-3">
          ...
          <span>
            Sertifikat ini terus diperbarui secara otomatis. Selesaikan seluruh 20 Level silabus untuk meraih gelar tertinggi <strong>Sobat Coding Grandmaster 👑</strong>!
          </span>
        </div>
      )}
